    ...
    return(
        <div>
            ...
            <div class="body">
                ...
                <p class="company">Nemours Childrens Hospital   |   <span class="companydescription">Healthcare</span></p>
                <p class="jobtitle">Enterprise Intelligence Developer, Data Analyst   |   <span class="dates_worked">May 2023 - Present</span></p>
                <p>
                    ...
                    <ul class="bullet_items">
                        <li>
                            <span class="boldtext">Patient Billing Dashboard</span> After organizing a meeting with 8-12 stakeholders, 
                        ...
                        <li>
                            <span class="boldtext">Excel VBA Dashboard</span> Drawing on old skills from a previous job, I updated and 
                ...
                <p class="company">KPMG   |   <span class="companydescription">Audit, Tax, and Advisory Services</span></p>
                <p class="jobtitle">Data Scientist, Senior Associate   |   <span class="dates_worked">Oct 2021 - April 2023</span></p>
                <p>
                    ...
                    <ul class="bullet_items">
                        <li>
                            <span class="boldtext">DRI (Data Remediation Information) Tool</span> I created a desktop application with 
                        ...
                        <li>
                            <span class="boldtext">Python Data Extraction Bot</span> Due to time constraints and our team not having access to our client’s 
                        ...
                        <li>
                            <span class="boldtext">Inventory Progress Tracker</span> Our client was required to conduct a yearly inventory of all of their 
                ...
                <p class="company">KPMG   |   <span class="companydescription">Audit, Tax, and Advisory Services</span></p>
                <p class="jobtitle">Data Analyst, Associate   |   <span class="dates_worked">Apr 2018 - Oct 2021</span></p>
                <p>
                    ...
                    <ul class="bullet_items">
                        <li>
                            <span class="boldtext">Created an Interactive Planograph</span> all in Excel using VBA. 
                        ...
                        <li>
                            <span class="boldtext">GCSS (Global Combat Support System) Application</span> I created a 
